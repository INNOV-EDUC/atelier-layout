...
use WCS\DefaultBundle\Entity\Theme;
use WCS\DefaultBundle\Form\ThemeType;
...
class ThemeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WCSDefaultBundle:Theme')->findAll();

        return $this->render('WCSDefaultBundle:Theme:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WCSDefaultBundle:Theme:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WCSDefaultBundle:Theme')->find($id);
        ...
        return $this->render('WCSDefaultBundle:Theme:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('WCSDefaultBundle:Theme:edit.html.twig', array(
            'entity'      => $entity,
